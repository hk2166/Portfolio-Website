...
const roboticsSkills = [
  {
    ...
    desc: "Developing firmware for Arduino-based systems including sensor interfacing, motor control, timing-critical logic, and hardware-level debugging.",
    color: "from-blue-500 to-cyan-500",
  },
  {
    icon: <Navigation className="w-8 h-8" />,
    title: "CAD & Motion Logic",
    desc: "Designing robot motion logic and navigation strategies, including path planning, decision flow, and behavior control for autonomous movement.",
    color: "from-green-500 to-emerald-500",
  },
  {
    icon: <Radio className="w-8 h-8" />,
    title: "IoT Systems",
    desc: "Implementing IoT-enabled robotics solutions with wireless communication, sensor data transmission, and basic cloud or dashboard integration.",
    color: "from-purple-500 to-pink-500",
  },
  {
    icon: <Gauge className="w-8 h-8" />,
    title: "Sensor Integration",
    desc: "Integrating and calibrating ultrasonic, IR, IMU, and proximity sensors to enable perception, feedback control, and environment-aware behavior.",
    color: "from-orange-500 to-red-500",
  },
  {
    icon: <Cog className="w-8 h-8" />,
    title: "Mechanical Design",
    desc: "Designing and assembling robot chassis and mechanical structures with a focus on stability, component placement, and real-world usability.",
    color: "from-indigo-500 to-purple-500",
  },
  {
    icon: <Cpu className="w-8 h-8" />,
    title: "Embedded Systems",
    desc: "Working close to hardware with microcontrollers, timers, interrupts, and communication protocols to build reliable embedded robotic systems.",
    color: "from-pink-500 to-rose-500",
  },
];
